...
main:
         ...
         ; [rbp - 192] - int important_row (<unset-scope-name>)
         ; [rbp - 200] - int upper_bound (<unset-scope-name>)
         ; [rbp - 208] - Vector<:Vector<:char:>:> board (<unset-scope-name>)
         ; [rbp - 216] - int i (<unset-scope-name>)
         ; [rbp - 224] - Vector<:Point:> adjacent_points (<unset-scope-name>)
         ; [rbp - 232] - int s (<unset-scope-name>)
         ; [rbp - 240] - Sensor sensor (<unset-scope-name>)
         ; [rbp - 248] - Point lhs (<unset-scope-name>)
         ; [rbp - 256] - int is_outside (<unset-scope-name>)
         ; [rbp - 264] - int ss (<unset-scope-name>)
         ; [rbp - 272] - Point rhs (<unset-scope-name>)
         ; [rbp - 280] - int is_outside (<unset-scope-name>)
         ; [rbp - 288] - int ss (<unset-scope-name>)
...
;------------------------------------------------------------------------------
         ...
         ; LHS
            ; Variable Declaration - nData
               mov rax, qword [rbp - 16]  ; __main____Vector__Point__pushBack__block__50__if__51__block__52__nData
         pop rdx ; rhs value
         mov qword [rbp - 16], rdx
         push rdx
         ; Statement results can be ignored
...
;---------------------------------------------------------------------------
         ...
         ; Assignment - '='
            ...
            ; LHS
               ; Variable Declaration - i
                  mov rax, qword [rbp - 24]  ; __main____Vector__Point__pushBack__block__50__if__51__block__52__for__53__i
            pop rdx ; rhs value
            mov qword [rbp - 24], rdx
            push rdx
         ; Loop init result can be discarded
...
; =========================================================================================================
         ...
         ; Dispatch Table Entries
         dq .__method____main____Sensor____contains__Point ; 0
         section .text
;------------------------------------------------------------------------------------------------------
...
;---------------------------------------------------------------------------------------------------------
         ...
         jmp .__end__method____main____Sensor____contains__Point
         .__method____main____Sensor____contains__Point:
         ; Function Header:
         ; Setup stack frame
         push rbp
         mov rbp, rsp
         ...
         mov qword [rbp - 8], rdx ; save this to a local
         ; Parameters
         ; Param: p [rbp + 24] (__main____Sensor__contains__p)
         ; Body
;---------------------------------------------------------------------------------------------------
         ; Code Block
         ; Return
...
;---------------------------------------------------------------------------------------------------
         ...
         pop rbp
         ret
         .__end__method____main____Sensor____contains__Point:
...
;------------------------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 32]  ; __main__for__107__l
         pop rdx ; rhs value
         mov qword [rbp - 32], rdx
         push rdx
         ; Loop init result can be discarded
...
;------------------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - tokens
         mov rax, qword [rbp - 40]  ; __main__for__107__block__108__tokens
         pop rdx ; rhs value
         mov qword [rbp - 40], rdx
         push rdx
         ; Statement results can be ignored
         ...
         mov rax, qword [rbp - 48]  ; __main__for__107__block__108__x0_token
         pop rdx ; rhs value
         mov qword [rbp - 48], rdx
         push rdx
         ; Statement results can be ignored
         ...
         mov rax, qword [rbp - 56]  ; __main__for__107__block__108__x0_str
         pop rdx ; rhs value
         mov qword [rbp - 56], rdx
         push rdx
         ; Statement results can be ignored
         ...
         mov rax, qword [rbp - 64]  ; __main__for__107__block__108__x0
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 72]  ; __main__for__107__block__108__y0_token
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 80]  ; __main__for__107__block__108__y0_str
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 88]  ; __main__for__107__block__108__y0
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 96]  ; __main__for__107__block__108__x1_token
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 104]  ; __main__for__107__block__108__x1_str
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 112]  ; __main__for__107__block__108__x1
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 120]  ; __main__for__107__block__108__y1_token
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 128]  ; __main__for__107__block__108__y1_str
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 136]  ; __main__for__107__block__108__y1
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 176]  ; __main__for__109__i
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 184]  ; __main__for__109__block__110__sensor
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 8]  ; __main__printboard__block__111__for__112__i
         pop rdx ; rhs value
         mov qword [rbp - 8], rdx
         push rdx
         ; Loop init result can be discarded
...
;------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - j
         mov rax, qword [rbp - 16]  ; __main__printboard__block__111__for__112__block__113__for__114__j
         pop rdx ; rhs value
         mov qword [rbp - 16], rdx
         push rdx
         ; Loop init result can be discarded
...
; ============================================================================================================
         ...
         mov rax, qword [rbp - 192]  ; __main__important_row
         pop rdx ; rhs value
         ...
         push rax
         ; LHS
         ; Variable Declaration - upper_bound
         mov rax, qword [rbp - 200]  ; __main__upper_bound
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 208]  ; __main__board
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 216]  ; __main__for__118__i
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------------------------
         ...
         push rax
         ; LHS
         ; Variable Declaration - adjacent_points
         mov rax, qword [rbp - 224]  ; __main__for__118__block__119__adjacent_points
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 232]  ; __main__for__118__block__119__for__120__s
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - sensor
         mov rax, qword [rbp - 240]  ; __main__for__118__block__119__for__120__block__121__sensor
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 248]  ; __main__for__118__block__119__for__120__block__121__if__122__block__124__lhs
         pop rdx ; rhs value
         ...
         ; Assignment - '='
            ; RHS
               ; Int Literal
                  ...
                  push rax
            ; LHS
               ; Variable Declaration - is_outside
                  mov rax, qword [rbp - 256]  ; __main__for__118__block__119__for__120__block__121__if__122__block__124__if__125__block__127__is_outside
            pop rdx ; rhs value
            ...
            ; Assignment - '='
               ; RHS
                  ; Int Literal
                     ...
                     push rax
               ; LHS
                  ; Variable Declaration - ss
                     mov rax, qword [rbp - 264]  ; __main__for__118__block__119__for__120__block__121__if__122__block__124__if__125__block__127__for__128__ss
               pop rdx ; rhs value
         ...
         ;---------------------------------------------------------------
                     ...
                     ; Condition
                        ; Method Call - Sensor::contains(Point) -> int
                           ...
                           ; Arguments
                              ...
                              pop rax
                              mov qword [rsp + 8], rax
                           call .__method____main____Sensor____contains__Point
                           ; Remove args
                           add rsp, 16
                           ; Push return value
                           push rax
               ...
               ;---------------------------------------------------------
                        ; Code Block
                           ...
                           ; Statement results can be ignored
                           pop rdx
                           ; Break out of __for__128
                           jmp .__endfor__128
               ;---------------------------------------------------------
                     jmp .__endif__130 ; jump to end of condition chain
                     ; End of if
.__endif__130:
         ;---------------------------------------------------------------
      ;------------------------------------------------------------------
...
;------------------------------------------------------------------------
         ; If-Statement
            ; Condition
               ; Identifier - int is_outside
                  push qword [rbp - 256]
               pop rdx ; __cond
               cmp rdx, 0 ; ensure condition is true
               je .__endif__132 ; jump to end
            ; Body
      ;------------------------------------------------------------------
               ; Code Block
                  ...
                  pop rdx
      ;------------------------------------------------------------------
            jmp .__endif__132 ; jump to end of condition chain
            ; End of if
.__endif__132:
;------------------------------------------------------------------------
;---------------------------------------------------------------------------
         jmp .__endif__125 ; jump to end of condition chain
         ; End of if
.__endif__125:
;---------------------------------------------------------------------------------
         ; Free Operator
         ...
         mov rax, qword [rbp - 272]  ; __main__for__118__block__119__for__120__block__121__if__122__block__124__rhs
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------
         ...
         ; Assignment - '='
            ...
            ; LHS
               ; Variable Declaration - is_outside
                  mov rax, qword [rbp - 280]  ; __main__for__118__block__119__for__120__block__121__if__122__block__124__if__134__block__136__is_outside
            pop rdx ; rhs value
...
;------------------------------------------------------------------------
         ...
         ; Init
            ; Assignment - '='
               ...
               ; LHS
                  ; Variable Declaration - ss
                     mov rax, qword [rbp - 288]  ; __main__for__118__block__119__for__120__block__121__if__122__block__124__if__134__block__136__for__137__ss
               pop rdx ; rhs value
...
;------------------------------------------------------------------------
      ...
      ;------------------------------------------------------------------
               ; Code Block
                  ...
                  pop rdx
      ;------------------------------------------------------------------
            jmp .__endif__141 ; jump to end of condition chain
            ; End of if
.__endif__141:
;------------------------------------------------------------------------
;---------------------------------------------------------------------------
...
;---------------------------------------------------------------------------------
         ...
         pop rdx
;------------------------------------------------------------------------------------
         jmp .__endif__122 ; jump to end of condition chain
         ; End of if
.__endif__122:
;------------------------------------------------------------------------------------------
;---------------------------------------------------------------------------------------------
