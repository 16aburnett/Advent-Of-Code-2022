...
int main () {
    ...
    __rhs = stack.back ();
    stack.pop_back ();
    __main__ROCK1 = static_cast<char>(static_cast<unsigned char>(__rhs));
    // Result of assignment
    stack.push_back (static_cast<long>(static_cast<unsigned char>(__main__ROCK1)));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    __rhs = stack.back ();
    stack.pop_back ();
    __main__PAPER1 = static_cast<char>(static_cast<unsigned char>(__rhs));
    // Result of assignment
    stack.push_back (static_cast<long>(static_cast<unsigned char>(__main__PAPER1)));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    // LHS
    // Variable declaration
    char __main__SCISSORS1;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__SCISSORS1 = static_cast<char>(static_cast<unsigned char>(__rhs));
    // Result of assignment
    stack.push_back (static_cast<long>(static_cast<unsigned char>(__main__SCISSORS1)));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    while (1)
    {
        ...
        long __elif__5x0__cond = stack.back ();
        stack.pop_back ();
        // get condition from stack
        if (__if__5__cond)
        {
            ...
            long __elif__7x0__cond = stack.back ();
            stack.pop_back ();
            // get condition from stack
            if (__if__7__cond)
            {
        ...
        if (__if__14__cond)
        {
            ...
            long __elif__16x0__cond = stack.back ();
            stack.pop_back ();
            // get condition from stack
            if (__if__16__cond)
            {
