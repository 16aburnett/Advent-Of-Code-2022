...
main:
         ...
         ; [rbp - 24] - Vector<:Valve:> valves (<unset-scope-name>)
         ; [rbp - 32] - Valve start_valve (<unset-scope-name>)
         ; [rbp - 40] - int l (<unset-scope-name>)
         ; [rbp - 48] - Vector<:char[]:> tokens (<unset-scope-name>)
         ; [rbp - 56] - char[] name (<unset-scope-name>)
         ; [rbp - 64] - char[] flow_str (<unset-scope-name>)
         ; [rbp - 72] - char[] flow_str1 (<unset-scope-name>)
         ; [rbp - 80] - int flow_rate (<unset-scope-name>)
         ; [rbp - 88] - Valve valve (<unset-scope-name>)
         ; [rbp - 96] - int l (<unset-scope-name>)
         ; [rbp - 104] - char[] tunnel_part (<unset-scope-name>)
         ; [rbp - 112] - Vector<:char[]:> tokens (<unset-scope-name>)
         ; [rbp - 120] - int i (<unset-scope-name>)
         ; [rbp - 128] - char[] tunnel (<unset-scope-name>)
         ; [rbp - 136] - Valve matching_valve (<unset-scope-name>)
         ; [rbp - 144] - int v (<unset-scope-name>)
         ; [rbp - 152] - int i (<unset-scope-name>)
         ; [rbp - 160] - Valve current_valve (<unset-scope-name>)
         ; [rbp - 168] - int total_pressure (<unset-scope-name>)
...
; ========================================================================
         ; Class Declaration - __main____Vector__Valve inherits __builtin____main__Object
            ...
            section .data
               ; Dispatch Table - this might need to be a malloc**
               .__dtable____main____Vector__Valve:
               ; Dispatch Table Entries
               dq .__method____main____Vector__Valve____pushBack__Valve ; 0
               dq .__method____main____Vector__Valve____popBack ; 1
               dq .__method____main____Vector__Valve____clear ; 2
               dq .__method____main____Vector__Valve____get__int ; 3
               dq .__method____main____Vector__Valve____set__int__Valve ; 4
            section .text
   ;---------------------------------------------------------------------
            ; Field - Valve[] Vector<:Valve:>::data
            section .data
            .__field____main____Vector__Valve____data: dq 1
            section .text
   ;---------------------------------------------------------------------
   ;---------------------------------------------------------------------
            ; Field - int Vector<:Valve:>::size
            section .data
            .__field____main____Vector__Valve____size: dq 2
            section .text
   ;---------------------------------------------------------------------
   ;---------------------------------------------------------------------
            ; Field - int Vector<:Valve:>::capacity
            section .data
            .__field____main____Vector__Valve____capacity: dq 3
            section .text
   ;---------------------------------------------------------------------
         ; skip over class methods
         jmp .__endclass____main____Vector__Valve
   ;---------------------------------------------------------------------
            ; Constructor Declaration - Vector<:Valve:>::Vector() -> Vector<:Valve:>
            jmp .__end__ctor____main____Vector__Valve____Vector
            .__ctor____main____Vector__Valve____Vector:
            ; Function Header:
               ; Setup stack frame
                  push rbp
                  mov rbp, rsp
               ...
               ; Creating Class Instance
                  ...
                  ; Add Dispatch Table
                  mov rax, qword [rbp - 8] ; this
                  mov qword [rax + 0], .__dtable____main____Vector__Valve ; this[0] = &dtable
               ; Parameters
            ; Body
      ;------------------------------------------------------------------
               ; Code Block
                        ...
                        ; Member Accessor Assignment
                           ; LHS
                              ; This keyword
                                 push qword [rbp - 8] ; __this
                           ; RHS
                              push qword [.__field____main____Vector__Valve____capacity] ; 
                           pop rdi ; rhs
                           pop rbx ; lhs
                     pop rdx ; rhs value
                     mov qword [rbx + 8*rdi], rdx
                        ...
                        ; Member Accessor Assignment
                           ; LHS
                              ; This keyword
                                 push qword [rbp - 8] ; __this
                           ; RHS
                              push qword [.__field____main____Vector__Valve____size] ; 
                           pop rdi ; rhs
                           pop rbx ; lhs
                     pop rdx ; rhs value
                     mov qword [rbx + 8*rdi], rdx
                           ...
                           ; Member Accessor
                              ; LHS
                                 ; This keyword
                                    push qword [rbp - 8] ; __this
                              ; RHS
                                 push qword [.__field____main____Vector__Valve____capacity] ; stored index associated with field that is being accessed
                              pop rdx ; rhs
                              pop rax ; lhs
                              push qword [rax + 8*rdx] ; lhs.rhs
                           pop rdx ; num elements for dimension[0]
                        ...
                        ; Member Accessor Assignment
                           ; LHS
                              ; This keyword
                                 push qword [rbp - 8] ; __this
                           ; RHS
                              push qword [.__field____main____Vector__Valve____data] ; 
                           pop rdi ; rhs
                           pop rbx ; lhs
                     pop rdx ; rhs value
                     mov qword [rbx + 8*rdi], rdx
      ...
      ;------------------------------------------------------------------
            ...
            pop rbp
            ret
         .__end__ctor____main____Vector__Valve____Vector:
...
;------------------------------------------------------------------------
         ...
         jmp .__end__ctor____main____Vector__Valve____Vector__int
         .__ctor____main____Vector__Valve____Vector__int:
         ; Function Header:
            ; Setup stack frame
               push rbp
               mov rbp, rsp
   ...
   ;---------------------------------------------------------------------
         ...
         pop rbp
         ret
         .__end__ctor____main____Vector__Valve____Vector__int:
...
;---------------------------------------------------------------------------
         ...
         jmp .__end__method____main____Vector__Valve____pushBack__Valve
         .__method____main____Vector__Valve____pushBack__Valve:
         ; Function Header:
         ; Setup stack frame
            push rbp
            mov rbp, rsp
            ; Local Variables - Each variable is currently 64-bit (sorry not sorry)
               ...
               mov rdx, qword [rbp + 16] ; param passed 'this'
               mov qword [rbp - 8], rdx ; save this to a local
               ; [rbp - 16] - Valve[] nData (<unset-scope-name>)
               ; [rbp - 24] - int i (<unset-scope-name>)
         ; Parameters
            ; Param: val [rbp + 24] (__main____Vector__Valve__pushBack__val)
         ; Body
   ;---------------------------------------------------------------------
            ; Code Block
      ;------------------------------------------------------------------
                                 ...
                                 ; Member Accessor
                                    ; LHS
                                       ; This keyword
                                          push qword [rbp - 8] ; __this
                                    ; RHS
                                       push qword [.__field____main____Vector__Valve____size] ; stored index associated with field that is being accessed
                                    pop rdx ; rhs
                                    pop rax ; lhs
                                    push qword [rax + 8*rdx] ; lhs.rhs
                              ; RHS
            ...
            ;------------------------------------------------------------
                     ; Code Block
                        ...
                        ; Assignment - '='
                           ...
                           ; LHS
                              ; Variable Declaration - nData
                                 mov rax, qword [rbp - 16]  ; __main____Vector__Valve__pushBack__block__14__if__15__block__16__nData
                           pop rdx ; rhs value
                           mov qword [rbp - 16], rdx
                           push rdx
                        ; Statement results can be ignored
               ...
               ;---------------------------------------------------------
                        ...
                        ; Init
                           ; Assignment - '='
                              ...
                              ; LHS
                                 ; Variable Declaration - i
                                    mov rax, qword [rbp - 24]  ; __main____Vector__Valve__pushBack__block__14__if__15__block__16__for__17__i
                              pop rdx ; rhs value
                              mov qword [rbp - 24], rdx
                              push rdx
                           ; Loop init result can be discarded
                                             ...
                                             ; Member Accessor
                                                ; LHS
                                                   ; This keyword
                                                      push qword [rbp - 8] ; __this
                                                ; RHS
                                                   push qword [.__field____main____Vector__Valve____data] ; stored index associated with field that is being accessed
                                                pop rdx ; rhs
                                                pop rax ; lhs
                                                push qword [rax + 8*rdx] ; lhs.rhs
                                          ; OFFSET
...
.__endif__15:
                     ...
                     ; Member Accessor Assignment
                        ; LHS
                           ; This keyword
                              push qword [rbp - 8] ; __this
                        ; RHS
                           push qword [.__field____main____Vector__Valve____size] ; size
                        pop rdi ; rhs
                        pop rbx ; lhs
                        mov rax, qword [rbx + 8*rdi]
                        add rax, 1
   ...
   ;---------------------------------------------------------------------
         ...
         pop rbp
         ret
         .__end__method____main____Vector__Valve____pushBack__Valve:
         ; End Method Declaration - .__method____main____Vector__Valve____pushBack__Valve
;---------------------------------------------------------------------------

;---------------------------------------------------------------------------
         ; Method Declaration - Vector<:Valve:>::popBack() -> Valve
         jmp .__end__method____main____Vector__Valve____popBack
         .__method____main____Vector__Valve____popBack:
         ; Function Header:
         ; Setup stack frame
            push rbp
            mov rbp, rsp
   ...
   ;---------------------------------------------------------------------
         ...
         pop rbp
         ret
         .__end__method____main____Vector__Valve____popBack:
         ; End Method Declaration - .__method____main____Vector__Valve____popBack
;---------------------------------------------------------------------------

;---------------------------------------------------------------------------
         ; Method Declaration - Vector<:Valve:>::clear() -> void
         jmp .__end__method____main____Vector__Valve____clear
         .__method____main____Vector__Valve____clear:
         ; Function Header:
         ; Setup stack frame
            push rbp
            mov rbp, rsp
...
.__while__21:
                  ...
                  ; Body
                     ; Method Call - Vector<:Valve:>::popBack() -> Valve
                        ...
                        ; RHS
                        ; Arguments
                        call .__method____main____Vector__Valve____popBack
                        ; Remove args
                        add rsp, 8
                        ; Push return value
                        push rax
...
.__endwhile__21:
   ...
   ;---------------------------------------------------------------------
         ...
         pop rbp
         ret
         .__end__method____main____Vector__Valve____clear:
         ; End Method Declaration - .__method____main____Vector__Valve____clear
;---------------------------------------------------------------------------

;---------------------------------------------------------------------------
         ; Method Declaration - Vector<:Valve:>::get(int) -> Valve
         jmp .__end__method____main____Vector__Valve____get__int
         .__method____main____Vector__Valve____get__int:
         ; Function Header:
         ; Setup stack frame
            push rbp
            mov rbp, rsp
            ; Local Variables - Each variable is currently 64-bit (sorry not sorry)
               ...
               mov qword [rbp - 8], rdx ; save this to a local
         ; Parameters
            ; Param: index [rbp + 24] (__main____Vector__Valve__get__index)
         ; Body
   ;---------------------------------------------------------------------
            ; Code Block
               ; Return
   ...
   ;---------------------------------------------------------------------
         ...
         pop rbp
         ret
         .__end__method____main____Vector__Valve____get__int:
         ; End Method Declaration - .__method____main____Vector__Valve____get__int
;---------------------------------------------------------------------------

;---------------------------------------------------------------------------
         ; Method Declaration - Vector<:Valve:>::set(int, Valve) -> void
         jmp .__end__method____main____Vector__Valve____set__int__Valve
         .__method____main____Vector__Valve____set__int__Valve:
         ; Function Header:
         ; Setup stack frame
            push rbp
            mov rbp, rsp
            ; Local Variables - Each variable is currently 64-bit (sorry not sorry)
               ...
               mov qword [rbp - 8], rdx ; save this to a local
         ; Parameters
            ; Param: index [rbp + 24] (__main____Vector__Valve__set__index)
            ; Param: value [rbp + 32] (__main____Vector__Valve__set__value)
         ; Body
   ;---------------------------------------------------------------------
            ; Code Block
               ; Assignment - '='
                  ; RHS
                     ; Identifier - Valve value
                        push qword [rbp - -32]
                  ; LHS
                     ; Subscript assignment
                        ; LHS
   ...
   ;---------------------------------------------------------------------
         ...
         pop rbp
         ret
         .__end__method____main____Vector__Valve____set__int__Valve:
         ; End Method Declaration - .__method____main____Vector__Valve____set__int__Valve
;---------------------------------------------------------------------------

.__endclass____main____Vector__Valve:
         ; End Class Declaration - __main____Vector__Valve
; ==============================================================================
...
; ====================================================================================
         ...
         section .data
         ; Dispatch Table - this might need to be a malloc**
         .__dtable____main____Valve:
         ; Dispatch Table Entries
         section .text
;---------------------------------------------------------------------------------
         ; Field - char[] Valve::name
         section .data
         .__field____main____Valve____name: dq 1
         section .text
;---------------------------------------------------------------------------------
;---------------------------------------------------------------------------------
         ; Field - int Valve::flow_rate
         section .data
         .__field____main____Valve____flow_rate: dq 2
         section .text
;---------------------------------------------------------------------------------
;---------------------------------------------------------------------------------
         ; Field - Vector<:Valve:> Valve::tunnels
         section .data
         .__field____main____Valve____tunnels: dq 3
         section .text
;---------------------------------------------------------------------------------
;---------------------------------------------------------------------------------
         ; Field - int Valve::is_open
         section .data
         .__field____main____Valve____is_open: dq 4
         section .text
;---------------------------------------------------------------------------------
         ; skip over class methods
         jmp .__endclass____main____Valve
;---------------------------------------------------------------------------------
         ; Constructor Declaration - Valve::Valve(char[], int) -> Valve
         jmp .__end__ctor____main____Valve____Valve__char__1__int
         .__ctor____main____Valve____Valve__char__1__int:
         ; Function Header:
         ; Setup stack frame
         push rbp
         mov rbp, rsp
         ...
         ; Add Dispatch Table
         mov rax, qword [rbp - 8] ; this
         mov qword [rax + 0], .__dtable____main____Valve ; this[0] = &dtable
         ; Parameters
         ; Param: name [rbp + 16]
         ; Param: flow_rate [rbp + 24]
         ; Body
;------------------------------------------------------------------------------
         ; Code Block
         ; Assignment - '='
            ...
            ; Member Accessor Assignment
               ; LHS
                  ; This keyword
                     push qword [rbp - 8] ; __this
               ; RHS
                  push qword [.__field____main____Valve____name] ; 
               pop rdi ; rhs
               pop rbx ; lhs
         pop rdx ; rhs value
         mov qword [rbx + 8*rdi], rdx
            ...
            ; Member Accessor Assignment
               ; LHS
                  ; This keyword
                     push qword [rbp - 8] ; __this
               ; RHS
                  push qword [.__field____main____Valve____flow_rate] ; 
               pop rdi ; rhs
               pop rbx ; lhs
         pop rdx ; rhs value
         mov qword [rbx + 8*rdi], rdx
         ...
         ; RHS
            ; Constructor Call - Vector<:Valve:>::Vector() -> Vector<:Valve:>
               ...
               sub rsp, 0
               ; Arguments
               ; Call Vector<:Valve:>::Vector()
               call .__ctor____main____Vector__Valve____Vector
               ; Remove args
               add rsp, 0
               ; Push return value
               push rax
            ...
            ; Member Accessor Assignment
               ; LHS
                  ; This keyword
                     push qword [rbp - 8] ; __this
               ; RHS
                  push qword [.__field____main____Valve____tunnels] ; 
               pop rdi ; rhs
               pop rbx ; lhs
         pop rdx ; rhs value
         mov qword [rbx + 8*rdi], rdx
            ...
            ; Member Accessor Assignment
               ; LHS
                  ; This keyword
                     push qword [rbp - 8] ; __this
               ; RHS
                  push qword [.__field____main____Valve____is_open] ; 
               pop rdi ; rhs
               pop rbx ; lhs
         pop rdx ; rhs value
         mov qword [rbx + 8*rdi], rdx
...
;------------------------------------------------------------------------------
         ...
         pop rbp
         ret
         .__end__ctor____main____Valve____Valve__char__1__int:
         ; End Constructor Declaration - __ctor____main____Valve____Valve__char__1__int
;------------------------------------------------------------------------------------

.__endclass____main____Valve:
         ; End Class Declaration - __main____Valve
; =======================================================================================

; =======================================================================================
         ; Function Declaration - print(Valve) -> void
         ; Skip over function declaration
         jmp .__end____main____print__Valve
.__main____print__Valve:
         ; Function Header:
         ; Setup stack frame
         push rbp
         mov rbp, rsp
            ...
            ; Member Accessor
               ; LHS
                  ; Identifier - Valve v
                     push qword [rbp - -16]
               ; RHS
                  push qword [.__field____main____Valve____name] ; stored index associated with field that is being accessed
               pop rdx ; rhs
               pop rax ; lhs
               push qword [rax + 8*rdx] ; lhs.rhs
         ; Move arg0's result to reverse order position on stack
            ...
            ; Member Accessor
               ; LHS
                  ; Identifier - Valve v
                     push qword [rbp - -16]
               ; RHS
                  push qword [.__field____main____Valve____flow_rate] ; stored index associated with field that is being accessed
               pop rdx ; rhs
               pop rax ; lhs
               push qword [rax + 8*rdx] ; lhs.rhs
         ; Move arg0's result to reverse order position on stack
...
;------------------------------------------------------------------------------
         ...
         ; LHS
            ; Variable Declaration - i
               mov rax, qword [rbp - 8]  ; __main__print__block__64__for__65__i
         pop rdx ; rhs value
         mov qword [rbp - 8], rdx
         push rdx
         ; Loop init result can be discarded
                     ...
                     ; Member Accessor
                        ; LHS
                           ; Identifier - Valve v
                              push qword [rbp - -16]
                        ; RHS
                           push qword [.__field____main____Valve____tunnels] ; stored index associated with field that is being accessed
                        pop rdx ; rhs
                        pop rax ; lhs
                        push qword [rax + 8*rdx] ; lhs.rhs
                  ; RHS
...
;---------------------------------------------------------------------------------
         ...
         pop rbp
         ret
.__end____main____print__Valve:
         ; End Function Declaration - print(Valve) -> void
; =======================================================================================

; =======================================================================================
         ; Function Declaration - println(Valve) -> void
         ; Skip over function declaration
         jmp .__end____main____println__Valve
.__main____println__Valve:
         ; Function Header:
         ; Setup stack frame
         push rbp
         mov rbp, rsp
...
;---------------------------------------------------------------------------------
         ...
         pop rbp
         ret
.__end____main____println__Valve:
         ; End Function Declaration - println(Valve) -> void
; =======================================================================================
         ...
         push rax
         ; LHS
         ; Variable Declaration - valves
         mov rax, qword [rbp - 24]  ; __main__valves
         pop rdx ; rhs value
         mov qword [rbp - 24], rdx
         push rdx
         ; Statement results can be ignored
         ...
         push 0
         ; LHS
         ; Variable Declaration - start_valve
         mov rax, qword [rbp - 32]  ; __main__start_valve
         pop rdx ; rhs value
         mov qword [rbp - 32], rdx
         push rdx
         ; Statement results can be ignored
...
;---------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 40]  ; __main__for__68__l
         pop rdx ; rhs value
         mov qword [rbp - 40], rdx
         push rdx
         ; Loop init result can be discarded
...
;---------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - tokens
            mov rax, qword [rbp - 48]  ; __main__for__68__block__69__tokens
         pop rdx ; rhs value
         mov qword [rbp - 48], rdx
         push rdx
         ; Statement results can be ignored
         ...
         ; Variable Declaration - name
            mov rax, qword [rbp - 56]  ; __main__for__68__block__69__name
         pop rdx ; rhs value
         mov qword [rbp - 56], rdx
         push rdx
         ; Statement results can be ignored
         ...
         ; Subscript
            ...
            push qword [rax + 8*rdx] ; pointer + sizeof(data_t) * offset
         ; LHS
         ; Variable Declaration - flow_str
            mov rax, qword [rbp - 64]  ; __main__for__68__block__69__flow_str
         pop rdx ; rhs value
         ...
         ; Function Call - substr(char[], int, int) -> char[]
            ...
            push rax
         ; LHS
         ; Variable Declaration - flow_str1
            mov rax, qword [rbp - 72]  ; __main__for__68__block__69__flow_str1
         pop rdx ; rhs value
         ...
         ; Function Call - stringToInt(char[]) -> int
            ...
            push rax
         ; LHS
         ; Variable Declaration - flow_rate
            mov rax, qword [rbp - 80]  ; __main__for__68__block__69__flow_rate
         pop rdx ; rhs value
         ...
         ; Constructor Call - Valve::Valve(char[], int) -> Valve
            ...
            ; Arguments
               ...
               pop rax
               mov qword [rsp + 8], rax
            ; Call Valve::Valve(char[], int)
            call .__ctor____main____Valve____Valve__char__1__int
            ; Remove args
            add rsp, 16
            ; Push return value
            push rax
         ; LHS
         ; Variable Declaration - valve
            mov rax, qword [rbp - 88]  ; __main__for__68__block__69__valve
         pop rdx ; rhs value
         ...
         sub rsp, 16
         ; LHS
         ; Identifier - Vector<:Valve:> valves
            push qword [rbp - 24]
         pop rax ; object parameter
         mov qword [rsp + 0], rax ; place as first parameter
         ; RHS
         ; Arguments
         ; Eval arg0
            ; Identifier - Valve valve
               push qword [rbp - 88]
         ; Move arg0's result to reverse order position on stack
         pop rax
         mov qword [rsp + 8], rax
         call .__method____main____Vector__Valve____pushBack__Valve
         ; Remove args
         add rsp, 16
         ; Push return value
         push rax
...
;---------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - l
         mov rax, qword [rbp - 96]  ; __main__for__72__l
         pop rdx ; rhs value
...
.__for__72:
         ...
         push rax
         pop rdx ; rhs value
         mov rax, qword [rbp - 96] ; read lhs value
         add rax, rdx      ; add lhs and rhs
         mov qword [rbp - 96], rax ; write back to lhs
         push rax          ; push result for other expressions
         ; Loop update result can be discarded
         pop rax
.__forcond__72:
...
;---------------------------------------------------------------------------------
         ...
         ; Function Call - substr(char[], int, int) -> char[]
            ...
            push rax
         ; LHS
         ; Variable Declaration - tunnel_part
            mov rax, qword [rbp - 104]  ; __main__for__72__block__73__tunnel_part
         pop rdx ; rhs value
         ...
         ; LHS
         ; Variable Declaration - tokens
            mov rax, qword [rbp - 112]  ; __main__for__72__block__73__tokens
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------
         ...
         ; LHS
            ; Variable Declaration - i
               mov rax, qword [rbp - 120]  ; __main__for__72__block__73__for__74__i
         pop rdx ; rhs value
            ...
            ; Assignment - '='
               ; RHS
                  ; Function Call - substr(char[], int, int) -> char[]
                     ...
                     push rax
               ; LHS
                  ; Variable Declaration - tunnel
                     mov rax, qword [rbp - 128]  ; __main__for__72__block__73__for__74__block__75__tunnel
               pop rdx ; rhs value
            ...
            ; Assignment - '='
               ; RHS
                  ; Subscript
                     ...
                     push qword [rax + 8*rdx] ; pointer + sizeof(data_t) * offset
               ; LHS
                  ; Variable Declaration - matching_valve
                     mov rax, qword [rbp - 136]  ; __main__for__72__block__73__for__74__block__75__matching_valve
               pop rdx ; rhs value
               ...
               ; Assignment - '='
                  ...
                  ; LHS
                     ; Variable Declaration - v
                        mov rax, qword [rbp - 144]  ; __main__for__72__block__73__for__74__block__75__for__76__v
                  pop rdx ; rhs value
...
.__endfor__76:
   ;---------------------------------------------------------------------
            ; Method Call - Vector<:Valve:>::pushBack(Valve) -> void
               ...
               ; Arguments
                  ; Eval arg0
                     ; Identifier - Valve matching_valve
                        push qword [rbp - 136]
                  ; Move arg0's result to reverse order position on stack
                  pop rax
                  mov qword [rsp + 8], rax
...
;---------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 152]  ; __main__for__81__i
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------
         ; Assignment - '='
         ; RHS
         ; Identifier - Valve start_valve
         push qword [rbp - 32]
         ; LHS
         ; Variable Declaration - current_valve
         mov rax, qword [rbp - 160]  ; __main__current_valve
         pop rdx ; rhs value
         ...
         push rax
         ; LHS
         ; Variable Declaration - total_pressure
         mov rax, qword [rbp - 168]  ; __main__total_pressure
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 176]  ; __main__for__83__i
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------
         ...
         ; Arguments
         ; Eval arg0
            ; Identifier - Valve current_valve
               push qword [rbp - 160]
         ; Move arg0's result to reverse order position on stack
         pop rax
         mov qword [rsp + 0], rax
...
; =======================================================================================
         ...
         section .data
.str0: db 'N', 'o', 't', ' ', 'i', 'm', 'p', 'l', 'e', 'm', 'e', 'n', 't', 'e', 'd', 0
.str1: db 'm', 'i', 'n', 'u', 't', 'e', ' ', 0
.str2: db 'a', 't', ' ', 'v', 'a', 'l', 'v', 'e', ',', ' ', 0
.float0: dq 0.0
.floatNegOne: dq -1.0
.floatZero: dq 0.0
.floatOne: dq 1.0
