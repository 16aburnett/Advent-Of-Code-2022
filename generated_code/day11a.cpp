...
class __main____Vector__Monkey : public __builtin____main__Object
{
    ...
    __main____Monkey** __field____main____Vector__Monkey____data;
    ...
    __main____Vector__Monkey (long __main____Vector__Monkey__size);
};
void __main____print__int____Vector__tparam0__int (__main____Vector__int* __main__print__v);
void __main____println__int____Vector__tparam0__int (__main____Vector__int* __main__println__v);
...
__main____Vector__Monkey::__main____Vector__Monkey ()
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
    ...
    // Array Allocator
    {
        ...
        __stackval = stack.back ();
        stack.pop_back ();
        __main____Monkey** __res = new __main____Monkey*[__stackval];
        stack.push_back (reinterpret_cast<long>(__res));
    }
    // LHS
    // Member Accessor Assignment
    ...
    __rhs = stack.back ();
    stack.pop_back ();
    (reinterpret_cast<__main____Vector__Monkey*>(__parent))->__field____main____Vector__Monkey____data = reinterpret_cast<__main____Monkey**>(__rhs);
    // Result of assignment
...
__main____Vector__Monkey::__main____Vector__Monkey (long __main____Vector__Monkey__Vector__size)
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
...
void __method____main____Vector__Monkey____pushBack__Monkey (__main____Vector__Monkey* __this, __main____Monkey* __main____Vector__Monkey__pushBack__val)
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
    ...
    if (__if__27__cond)
    {
        ...
        // LHS
        // Variable declaration
        __main____Monkey** __main____Vector__Monkey__pushBack__block__26__if__27__block__28__nData;
        __rhs = stack.back ();
        stack.pop_back ();
        __main____Vector__Monkey__pushBack__block__26__if__27__block__28__nData = reinterpret_cast<__main____Monkey**>(__rhs);
        // Result of assignment
        ...
        while (1)
        {
            ...
            __rhs = stack.back ();
            stack.pop_back ();
            (reinterpret_cast<__main____Monkey**>(__pointer))[__offset] = reinterpret_cast<__main____Monkey*>(__rhs);
            // Result of assignment
            stack.push_back (reinterpret_cast<long>((reinterpret_cast<__main____Monkey**>(__pointer))[__offset]));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
        ...
        __stackval = stack.back ();
        stack.pop_back ();
        delete reinterpret_cast<__main____Monkey**>(__stackval);
        stack.push_back (0);
        // Statement results can be ignored
        stack.pop_back ();
        // End Statement
...
__main____Monkey* __method____main____Vector__Monkey____popBack (__main____Vector__Monkey* __this)
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
    ...
    __res = stack.back ();
    stack.pop_back ();
    return reinterpret_cast<__main____Monkey*>(__res);
    //---------------------------------------------------------------------
}
...
void __method____main____Vector__Monkey____clear (__main____Vector__Monkey* __this)
{
    ...
    while (1)
    {
        ...
        // RHS
        {
            ...
            __obj = stack.back ();
            stack.pop_back ();
            __main____Monkey* __res = __method____main____Vector__Monkey____popBack (reinterpret_cast<__main____Vector__Monkey*>(__obj));
            stack.push_back (reinterpret_cast<long>(__res));
        }
        // Statement results can be ignored
        stack.pop_back ();
...
__main____Monkey* __method____main____Vector__Monkey____get__int (__main____Vector__Monkey* __this, long __main____Vector__Monkey__get__index)
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
...
void __method____main____Vector__Monkey____set__int__Monkey (__main____Vector__Monkey* __this, long __main____Vector__Monkey__set__index, __main____Monkey* __main____Vector__Monkey__set__value)
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
...
long __main____strlen__char__1 (char* __main__strlen__str)
{
    ...
    // LHS
    // Variable declaration
    long __main__strlen__block__41__size;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__strlen__block__41__size = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__strlen__block__41__size));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    while (1)
    {
        ...
        // Not Equal
        {
            ...
            // Subscript Expression
            {
                ...
                // Post-Increment
                {
                    long __res = __main__strlen__block__41__size;
...
long __main____strcmp__char__1__char__1 (char* __main__strcmp__a, char* __main__strcmp__b)
{
    ...
    // LHS
    // Variable declaration
    long __main__strcmp__block__44__asize;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__strcmp__block__44__asize = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__strcmp__block__44__asize));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    // LHS
    // Variable declaration
    long __main__strcmp__block__44__bsize;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__strcmp__block__44__bsize = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__strcmp__block__44__bsize));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    // LHS
    // Variable declaration
    long __main__strcmp__block__44__for__46__i;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__strcmp__block__44__for__46__i = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__strcmp__block__44__for__46__i));
    // We can ignore the init result
    stack.pop_back ();
    // Using an infinite loop so we can write a separate multi-line condition
    while (1)
...
char* __main____substr__char__1__int__int (char* __main__substr__a, long __main__substr__start, long __main__substr__end)
{
    ...
    // LHS
    // Variable declaration
    char* __main__substr__block__50__res;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__substr__block__50__res = *reinterpret_cast<char**>(&__rhs);
    // Result of assignment
    stack.push_back (reinterpret_cast<long>(__main__substr__block__50__res));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    // LHS
    // Variable declaration
    long __main__substr__block__50__for__51__i;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__substr__block__50__for__51__i = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__substr__block__50__for__51__i));
    // We can ignore the init result
    stack.pop_back ();
    // Using an infinite loop so we can write a separate multi-line condition
    while (1)
...
long __main____first_index_of__char__1__char (char* __main__first_index_of__arr, char __main__first_index_of__c)
{
    ...
    // LHS
    // Variable declaration
    long __main__first_index_of__block__53__size;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__first_index_of__block__53__size = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__first_index_of__block__53__size));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    // LHS
    // Variable declaration
    long __main__first_index_of__block__53__for__54__i;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__first_index_of__block__53__for__54__i = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__first_index_of__block__53__for__54__i));
    // We can ignore the init result
    stack.pop_back ();
    // Using an infinite loop so we can write a separate multi-line condition
    while (1)
...
__main____Vector__char__1* __main____split__char__1__char (char* __main__split__str, char __main__split__delim)
{
    ...
    // LHS
    // Variable declaration
    __main____Vector__char__1* __main__split__block__57__tokens;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__split__block__57__tokens = reinterpret_cast<__main____Vector__char__1*>(__rhs);
    // Result of assignment
    stack.push_back (reinterpret_cast<long>(__main__split__block__57__tokens));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    // LHS
    // Variable declaration
    long __main__split__block__57__size;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__split__block__57__size = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__split__block__57__size));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    // LHS
    // Variable declaration
    long __main__split__block__57__i;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__split__block__57__i = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__split__block__57__i));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    // LHS
    // Variable declaration
    long __main__split__block__57__j;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__split__block__57__j = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__split__block__57__j));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    while (1)
    {
        ...
        if (__if__60__cond)
        {
            ...
            // LHS
            // Variable declaration
            long __main__split__block__57__while__58__block__59__if__60__block__61__count;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__split__block__57__while__58__block__59__if__60__block__61__count = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__split__block__57__while__58__block__59__if__60__block__61__count));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
            ...
            // LHS
            // Variable declaration
            long __main__split__block__57__while__58__block__59__if__60__block__61__k;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__split__block__57__while__58__block__59__if__60__block__61__k = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__split__block__57__while__58__block__59__if__60__block__61__k));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
            ...
            while (1)
            {
                ...
                // Not Equal
                {
                    ...
                    // Subscript Expression
                    {
                        ...
                        // Post-Increment
                        {
                            long __res = __main__split__block__57__while__58__block__59__if__60__block__61__k;
            ...
            // LHS
            // Variable declaration
            long __main__split__block__57__while__58__block__59__if__60__block__61__for__64__k;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__split__block__57__while__58__block__59__if__60__block__61__for__64__k = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__split__block__57__while__58__block__59__if__60__block__61__for__64__k));
            // We can ignore the init result
            stack.pop_back ();
            // Using an infinite loop so we can write a separate multi-line condition
            while (1)
            {
                ...
                // Subscript Expression
                {
                    ...
                    // Post-Increment
                    {
                        long __res = __main__split__block__57__i;
...
double __main____max__float__float (double __main__max__a, double __main__max__b)
{
    ...
    long __if__69__cond = stack.back ();
    stack.pop_back ();
    // get condition from stack
    if (__if__69__cond)
    {
...
double __main____min__float__float (double __main__min__a, double __main__min__b)
{
    ...
    long __if__73__cond = stack.back ();
    stack.pop_back ();
    // get condition from stack
    if (__if__73__cond)
    {
...
__main____Monkey::__main____Monkey ()
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
...
void __main____println__Vector__tparam0__Monkey (__main____Vector__Monkey* __main__println__monkeys)
{
    ...
    // LHS
    // Variable declaration
    long __main__println__block__100__for__101__i;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__println__block__100__for__101__i = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__println__block__100__for__101__i));
    // We can ignore the init result
    stack.pop_back ();
    // Using an infinite loop so we can write a separate multi-line condition
    while (1)
    {
        ...
        // Function Call - println<:int:>(Vector<:int:>) -> void
        {
            ...
            __main____Vector__int* __arg0 = reinterpret_cast<__main____Vector__int*>(__stackval);
            // println
            __main____println__int____Vector__tparam0__int (__arg0);
            // push dummy value - funcall returns void
            stack.push_back (0);
        }
        // Statement results can be ignored
...
int main () {
    ...
    // LHS
    // Variable declaration
    long __main__for__81__l;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__for__81__l = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__for__81__l));
    // We can ignore the init result
    stack.pop_back ();
    // Using an infinite loop so we can write a separate multi-line condition
    while (1)
    {
        ...
        // LHS
        // Variable declaration
        __main____Monkey* __main__for__81__block__82__monkey;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__81__block__82__monkey = reinterpret_cast<__main____Monkey*>(__rhs);
        // Result of assignment
        stack.push_back (reinterpret_cast<long>(__main__for__81__block__82__monkey));
        // Statement results can be ignored
        stack.pop_back ();
        // End Statement
        ...
        // LHS
        // Variable declaration
        char* __main__for__81__block__82__items_str;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__81__block__82__items_str = *reinterpret_cast<char**>(&__rhs);
        // Result of assignment
        stack.push_back (reinterpret_cast<long>(__main__for__81__block__82__items_str));
        // Statement results can be ignored
        stack.pop_back ();
        // End Statement
        ...
        // LHS
        // Variable declaration
        __main____Vector__char__1* __main__for__81__block__82__tokens0;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__81__block__82__tokens0 = reinterpret_cast<__main____Vector__char__1*>(__rhs);
        // Result of assignment
        stack.push_back (reinterpret_cast<long>(__main__for__81__block__82__tokens0));
        // Statement results can be ignored
        stack.pop_back ();
        // End Statement
        ...
        // LHS
        // Variable declaration
        long __main__for__81__block__82__for__83__i;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__81__block__82__for__83__i = *reinterpret_cast<long*>(&__rhs);
        // Result of assignment
        stack.push_back (*reinterpret_cast<long*>(&__main__for__81__block__82__for__83__i));
        // We can ignore the init result
        stack.pop_back ();
        // Using an infinite loop so we can write a separate multi-line condition
        while (1)
        {
            ...
            // LHS
            // Variable declaration
            char* __main__for__81__block__82__for__83__block__84__item_str;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__81__block__82__for__83__block__84__item_str = *reinterpret_cast<char**>(&__rhs);
            // Result of assignment
            stack.push_back (reinterpret_cast<long>(__main__for__81__block__82__for__83__block__84__item_str));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
            ...
            // LHS
            // Variable declaration
            long __main__for__81__block__82__for__83__block__84__item;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__81__block__82__for__83__block__84__item = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__81__block__82__for__83__block__84__item));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
        ...
        // LHS
        // Variable declaration
        long __main__for__81__block__82__for__85__i;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__81__block__82__for__85__i = *reinterpret_cast<long*>(&__rhs);
        // Result of assignment
        stack.push_back (*reinterpret_cast<long*>(&__main__for__81__block__82__for__85__i));
        // We can ignore the init result
        stack.pop_back ();
        // Using an infinite loop so we can write a separate multi-line condition
        while (1)
        ...
        if (__if__86__cond)
        {
            ...
            // LHS
            // Variable declaration
            __main____Vector__char__1* __main__for__81__block__82__if__86__block__87__tokens1;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__81__block__82__if__86__block__87__tokens1 = reinterpret_cast<__main____Vector__char__1*>(__rhs);
            // Result of assignment
            stack.push_back (reinterpret_cast<long>(__main__for__81__block__82__if__86__block__87__tokens1));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
            ...
            // LHS
            // Variable declaration
            long __main__for__81__block__82__if__86__block__87__for__91__j;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__81__block__82__if__86__block__87__for__91__j = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__81__block__82__if__86__block__87__for__91__j));
            // We can ignore the init result
            stack.pop_back ();
            // Using an infinite loop so we can write a separate multi-line condition
            while (1)
        ...
        else
        {
            ...
            // LHS
            // Variable declaration
            __main____Vector__char__1* __main__for__81__block__82__else__86__block__92__tokens1;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__81__block__82__else__86__block__92__tokens1 = reinterpret_cast<__main____Vector__char__1*>(__rhs);
            // Result of assignment
            stack.push_back (reinterpret_cast<long>(__main__for__81__block__82__else__86__block__92__tokens1));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
            ...
            // LHS
            // Variable declaration
            long __main__for__81__block__82__else__86__block__92__for__96__j;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__81__block__82__else__86__block__92__for__96__j = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__81__block__82__else__86__block__92__for__96__j));
            // We can ignore the init result
            stack.pop_back ();
            // Using an infinite loop so we can write a separate multi-line condition
            while (1)
        ...
        // LHS
        // Variable declaration
        __main____Vector__char__1* __main__for__81__block__82__tokens2;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__81__block__82__tokens2 = reinterpret_cast<__main____Vector__char__1*>(__rhs);
        // Result of assignment
        stack.push_back (reinterpret_cast<long>(__main__for__81__block__82__tokens2));
        // Statement results can be ignored
        stack.pop_back ();
        // End Statement
        ...
        // LHS
        // Variable declaration
        long __main__for__81__block__82__for__97__j;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__81__block__82__for__97__j = *reinterpret_cast<long*>(&__rhs);
        // Result of assignment
        stack.push_back (*reinterpret_cast<long*>(&__main__for__81__block__82__for__97__j));
        // We can ignore the init result
        stack.pop_back ();
        // Using an infinite loop so we can write a separate multi-line condition
        while (1)
        ...
        // LHS
        // Variable declaration
        __main____Vector__char__1* __main__for__81__block__82__tokens3;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__81__block__82__tokens3 = reinterpret_cast<__main____Vector__char__1*>(__rhs);
        // Result of assignment
        stack.push_back (reinterpret_cast<long>(__main__for__81__block__82__tokens3));
        // Statement results can be ignored
        stack.pop_back ();
        // End Statement
        ...
        // LHS
        // Variable declaration
        long __main__for__81__block__82__for__98__j;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__81__block__82__for__98__j = *reinterpret_cast<long*>(&__rhs);
        // Result of assignment
        stack.push_back (*reinterpret_cast<long*>(&__main__for__81__block__82__for__98__j));
        // We can ignore the init result
        stack.pop_back ();
        // Using an infinite loop so we can write a separate multi-line condition
        while (1)
        ...
        // LHS
        // Variable declaration
        __main____Vector__char__1* __main__for__81__block__82__tokens4;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__81__block__82__tokens4 = reinterpret_cast<__main____Vector__char__1*>(__rhs);
        // Result of assignment
        stack.push_back (reinterpret_cast<long>(__main__for__81__block__82__tokens4));
        // Statement results can be ignored
        stack.pop_back ();
        // End Statement
        ...
        // LHS
        // Variable declaration
        long __main__for__81__block__82__for__99__j;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__81__block__82__for__99__j = *reinterpret_cast<long*>(&__rhs);
        // Result of assignment
        stack.push_back (*reinterpret_cast<long*>(&__main__for__81__block__82__for__99__j));
        // We can ignore the init result
        stack.pop_back ();
        // Using an infinite loop so we can write a separate multi-line condition
        while (1)
        ...
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__81__l = __main__for__81__l + *reinterpret_cast<long*>(&__rhs);
        // Result of assignment
        stack.push_back (*reinterpret_cast<long*>(&__main__for__81__l));
        // We can ignore the update result
        stack.pop_back ();
    ...
    // LHS
    // Variable declaration
    long __main__for__103__r;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__for__103__r = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__for__103__r));
    // We can ignore the init result
    stack.pop_back ();
    // Using an infinite loop so we can write a separate multi-line condition
    while (1)
    {
        ...
        // LHS
        // Variable declaration
        long __main__for__103__block__104__for__105__m;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__103__block__104__for__105__m = *reinterpret_cast<long*>(&__rhs);
        // Result of assignment
        stack.push_back (*reinterpret_cast<long*>(&__main__for__103__block__104__for__105__m));
        // We can ignore the init result
        stack.pop_back ();
        // Using an infinite loop so we can write a separate multi-line condition
        while (1)
        {
            ...
            // LHS
            // Variable declaration
            __main____Monkey* __main__for__103__block__104__for__105__block__106__monkey;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__103__block__104__for__105__block__106__monkey = reinterpret_cast<__main____Monkey*>(__rhs);
            // Result of assignment
            stack.push_back (reinterpret_cast<long>(__main__for__103__block__104__for__105__block__106__monkey));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
            ...
            // LHS
            // Variable declaration
            __main____Vector__int* __main__for__103__block__104__for__105__block__106__monkey_items;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__103__block__104__for__105__block__106__monkey_items = reinterpret_cast<__main____Vector__int*>(__rhs);
            // Result of assignment
            stack.push_back (reinterpret_cast<long>(__main__for__103__block__104__for__105__block__106__monkey_items));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
            ...
            // LHS
            // Variable declaration
            long __main__for__103__block__104__for__105__block__106__for__107__i;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__103__block__104__for__105__block__106__for__107__i = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__103__block__104__for__105__block__106__for__107__i));
            // We can ignore the init result
            stack.pop_back ();
            // Using an infinite loop so we can write a separate multi-line condition
            while (1)
            {
                ...
                // LHS
                // Variable declaration
                long __main__for__103__block__104__for__105__block__106__for__107__block__108__worry_level;
                __rhs = stack.back ();
                stack.pop_back ();
                __main__for__103__block__104__for__105__block__106__for__107__block__108__worry_level = *reinterpret_cast<long*>(&__rhs);
                // Result of assignment
                stack.push_back (*reinterpret_cast<long*>(&__main__for__103__block__104__for__105__block__106__for__107__block__108__worry_level));
                // Statement results can be ignored
                stack.pop_back ();
                // End Statement
                ...
                long __elif__109x0__cond = stack.back ();
                stack.pop_back ();
                // get condition from stack
                if (__if__109__cond)
                {
                    ...
                    __rhs = stack.back ();
                    stack.pop_back ();
                    __main__for__103__block__104__for__105__block__106__for__107__block__108__worry_level = __main__for__103__block__104__for__105__block__106__for__107__block__108__worry_level + *reinterpret_cast<long*>(&__rhs);
                    // Result of assignment
                    stack.push_back (*reinterpret_cast<long*>(&__main__for__103__block__104__for__105__block__106__for__107__block__108__worry_level));
                    // Statement results can be ignored
                    stack.pop_back ();
    ...
    // LHS
    // Variable declaration
    long __main__for__111__i;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__for__111__i = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__for__111__i));
    // We can ignore the init result
    stack.pop_back ();
    // Using an infinite loop so we can write a separate multi-line condition
    while (1)
