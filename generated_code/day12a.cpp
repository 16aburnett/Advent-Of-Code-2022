...
class __main____Vector__int; // Vector<:int:>
...
class __main____Vector__Vector : public __builtin____main__Object
{
    ...
    __main____Vector__int** __field____main____Vector__Vector____data;
...
class __main____Vec : public __builtin____main__Object
{
    ...
    __main____Vec ();
    __main____Vec (long __main____Vec__i, long __main____Vec__j);
    __main____Vec (long __main____Vec__i, long __main____Vec__j, long __main____Vec__time);
};
class __main____Vec; // Vec
...
class __main____Node__Vec : public __builtin____main__Object
{
    ...
    __main____Node__Vec (__main____Vec* __main____Node__Vec__data, __main____Node__Vec* __main____Node__Vec__prev, __main____Node__Vec* __main____Node__Vec__next);
};
class __main____Vec; // Vec
...
__main____Vector__Vector::__main____Vector__Vector ()
{
    ...
    // Array Allocator
    {
        ...
        __stackval = stack.back ();
        stack.pop_back ();
        __main____Vector__int** __res = new __main____Vector__int*[__stackval];
        stack.push_back (reinterpret_cast<long>(__res));
    }
    // LHS
    // Member Accessor Assignment
    ...
    __rhs = stack.back ();
    stack.pop_back ();
    (reinterpret_cast<__main____Vector__Vector*>(__parent))->__field____main____Vector__Vector____data = reinterpret_cast<__main____Vector__int**>(__rhs);
    // Result of assignment
...
void __method____main____Vector__Vector____pushBack__Vector (__main____Vector__Vector* __this, __main____Vector__int* __main____Vector__Vector__pushBack__val)
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
    ...
    if (__if__27__cond)
    {
        ...
        // LHS
        // Variable declaration
        __main____Vector__int** __main____Vector__Vector__pushBack__block__26__if__27__block__28__nData;
        __rhs = stack.back ();
        stack.pop_back ();
        __main____Vector__Vector__pushBack__block__26__if__27__block__28__nData = reinterpret_cast<__main____Vector__int**>(__rhs);
        // Result of assignment
        ...
        while (1)
        {
            ...
            __rhs = stack.back ();
            stack.pop_back ();
            (reinterpret_cast<__main____Vector__int**>(__pointer))[__offset] = reinterpret_cast<__main____Vector__int*>(__rhs);
            // Result of assignment
            stack.push_back (reinterpret_cast<long>((reinterpret_cast<__main____Vector__int**>(__pointer))[__offset]));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
        ...
        __stackval = stack.back ();
        stack.pop_back ();
        delete reinterpret_cast<__main____Vector__int**>(__stackval);
        stack.push_back (0);
        // Statement results can be ignored
        stack.pop_back ();
        // End Statement
...
__main____Vector__int* __method____main____Vector__Vector____popBack (__main____Vector__Vector* __this)
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
    ...
    __res = stack.back ();
    stack.pop_back ();
    return reinterpret_cast<__main____Vector__int*>(__res);
    //---------------------------------------------------------------------
}
...
void __method____main____Vector__Vector____clear (__main____Vector__Vector* __this)
{
    ...
    while (1)
    {
        ...
        // RHS
        {
            ...
            __obj = stack.back ();
            stack.pop_back ();
            __main____Vector__int* __res = __method____main____Vector__Vector____popBack (reinterpret_cast<__main____Vector__Vector*>(__obj));
            stack.push_back (reinterpret_cast<long>(__res));
        }
        // Statement results can be ignored
        stack.pop_back ();
...
__main____Vector__int* __method____main____Vector__Vector____get__int (__main____Vector__Vector* __this, long __main____Vector__Vector__get__index)
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
...
void __method____main____Vector__Vector____set__int__Vector (__main____Vector__Vector* __this, long __main____Vector__Vector__set__index, __main____Vector__int* __main____Vector__Vector__set__value)
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
...
__main____Vec::__main____Vec (long __main____Vec__Vec__i, long __main____Vec__Vec__j)
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
...
__main____Vec::__main____Vec (long __main____Vec__Vec__i, long __main____Vec__Vec__j, long __main____Vec__Vec__time)
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
...
__main____Node__Vec::__main____Node__Vec (__main____Vec* __main____Node__Vec__Node__data, __main____Node__Vec* __main____Node__Vec__Node__prev, __main____Node__Vec* __main____Node__Vec__Node__next)
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
...
__main____LinkedList__Vec::__main____LinkedList__Vec ()
{
    // Function Header
    // This stack is used to store results of expressions
    std::vector<long> stack;
    ...
    // Constructor Call - Node<:Vec:>::Node(Vec, Node<:Vec:>, Node<:Vec:>) -> Node<:Vec:>
    {
        ...
        // Function Call - Vec::Vec() -> Vec
        {
            // Arguments
            // Vec::Vec
            __main____Vec* __res = new __main____Vec ();
            stack.push_back (reinterpret_cast<long>(__res));
        }
        // Null Literal
        stack.push_back ((long)nullptr);
        ...
        stack.pop_back ();
        // Reinterpret from general register
        std::nullptr_t __arg2 = nullptr;
        __stackval = stack.back ();
        stack.pop_back ();
        // Reinterpret from general register
        std::nullptr_t __arg1 = nullptr;
        __stackval = stack.back ();
        stack.pop_back ();
        // Reinterpret from general register
...
void __method____main____LinkedList__Vec____pushBack__Vec (__main____LinkedList__Vec* __this, __main____Vec* __main____LinkedList__Vec__pushBack__val)
{
    ...
    // LHS
    // Variable declaration
    __main____Node__Vec* __main____LinkedList__Vec__pushBack__block__80__tail;
    __rhs = stack.back ();
    stack.pop_back ();
    __main____LinkedList__Vec__pushBack__block__80__tail = reinterpret_cast<__main____Node__Vec*>(__rhs);
    // Result of assignment
    stack.push_back (reinterpret_cast<long>(__main____LinkedList__Vec__pushBack__block__80__tail));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    // Constructor Call - Node<:Vec:>::Node(Vec, Node<:Vec:>, Node<:Vec:>) -> Node<:Vec:>
    {
        ...
        stack.pop_back ();
        // Reinterpret from general register
        __main____Node__Vec* __arg2 = reinterpret_cast<__main____Node__Vec*>(__stackval);
        __stackval = stack.back ();
        stack.pop_back ();
        // Reinterpret from general register
        __main____Node__Vec* __arg1 = reinterpret_cast<__main____Node__Vec*>(__stackval);
        __stackval = stack.back ();
        stack.pop_back ();
        // Reinterpret from general register
        __main____Vec* __arg0 = reinterpret_cast<__main____Vec*>(__stackval);
    ...
    // LHS
    // Variable declaration
    __main____Node__Vec* __main____LinkedList__Vec__pushBack__block__80__node;
    __rhs = stack.back ();
    stack.pop_back ();
    __main____LinkedList__Vec__pushBack__block__80__node = reinterpret_cast<__main____Node__Vec*>(__rhs);
    // Result of assignment
    stack.push_back (reinterpret_cast<long>(__main____LinkedList__Vec__pushBack__block__80__node));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
...
void __method____main____LinkedList__Vec____pushFront__Vec (__main____LinkedList__Vec* __this, __main____Vec* __main____LinkedList__Vec__pushFront__val)
{
    ...
    // LHS
    // Variable declaration
    __main____Node__Vec* __main____LinkedList__Vec__pushFront__block__81__head;
    __rhs = stack.back ();
    stack.pop_back ();
    __main____LinkedList__Vec__pushFront__block__81__head = reinterpret_cast<__main____Node__Vec*>(__rhs);
    // Result of assignment
    stack.push_back (reinterpret_cast<long>(__main____LinkedList__Vec__pushFront__block__81__head));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    // LHS
    // Variable declaration
    __main____Node__Vec* __main____LinkedList__Vec__pushFront__block__81__node;
    __rhs = stack.back ();
    stack.pop_back ();
    __main____LinkedList__Vec__pushFront__block__81__node = reinterpret_cast<__main____Node__Vec*>(__rhs);
    // Result of assignment
    stack.push_back (reinterpret_cast<long>(__main____LinkedList__Vec__pushFront__block__81__node));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
...
__main____Vec* __method____main____LinkedList__Vec____popBack (__main____LinkedList__Vec* __this)
{
    ...
    if (__if__83__cond)
    {
        ...
        __res = stack.back ();
        stack.pop_back ();
        return reinterpret_cast<__main____Vec*>(__res);
    }
    // End of if
    //---------------------------------------------------------------------
    // Statement
    ...
    // LHS
    // Variable declaration
    __main____Node__Vec* __main____LinkedList__Vec__popBack__block__82__tail;
    __rhs = stack.back ();
    stack.pop_back ();
    __main____LinkedList__Vec__popBack__block__82__tail = reinterpret_cast<__main____Node__Vec*>(__rhs);
    // Result of assignment
    stack.push_back (reinterpret_cast<long>(__main____LinkedList__Vec__popBack__block__82__tail));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
...
__main____Vec* __method____main____LinkedList__Vec____popFront (__main____LinkedList__Vec* __this)
{
    ...
    // LHS
    // Variable declaration
    __main____Node__Vec* __main____LinkedList__Vec__popFront__block__84__head;
    __rhs = stack.back ();
    stack.pop_back ();
    __main____LinkedList__Vec__popFront__block__84__head = reinterpret_cast<__main____Node__Vec*>(__rhs);
    // Result of assignment
    stack.push_back (reinterpret_cast<long>(__main____LinkedList__Vec__popFront__block__84__head));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
...
__main____Node__Vec* __method____main____LinkedList__Vec____begin (__main____LinkedList__Vec* __this)
{
    ...
    __res = stack.back ();
    stack.pop_back ();
    return reinterpret_cast<__main____Node__Vec*>(__res);
    //---------------------------------------------------------------------
}
...
long __main____bfs__Vector__tparam0__Vector__Vector__tparam0__Vector__Vec__Vec (__main____Vector__Vector* __main__bfs__elevations, __main____Vector__Vector* __main__bfs__board, __main____Vec* __main__bfs__start_pos, __main____Vec* __main__bfs__end_pos)
{
    ...
    // LHS
    // Variable declaration
    __main____LinkedList__Vec* __main__bfs__block__100__frontier;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__bfs__block__100__frontier = reinterpret_cast<__main____LinkedList__Vec*>(__rhs);
    // Result of assignment
    stack.push_back (reinterpret_cast<long>(__main__bfs__block__100__frontier));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    while (1)
    {
        ...
        // LHS
        // Variable declaration
        __main____Vec* __main__bfs__block__100__while__101__block__102__pos;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__bfs__block__100__while__101__block__102__pos = reinterpret_cast<__main____Vec*>(__rhs);
        // Result of assignment
        stack.push_back (reinterpret_cast<long>(__main__bfs__block__100__while__101__block__102__pos));
        // Statement results can be ignored
        stack.pop_back ();
        // End Statement
...
int main () {
    ...
    // LHS
    // Variable declaration
    long __main__for__93__l;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__for__93__l = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__for__93__l));
    // We can ignore the init result
    stack.pop_back ();
    // Using an infinite loop so we can write a separate multi-line condition
    while (1)
    {
        ...
        // LHS
        // Variable declaration
        long __main__for__93__block__94__size;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__93__block__94__size = *reinterpret_cast<long*>(&__rhs);
        // Result of assignment
        stack.push_back (*reinterpret_cast<long*>(&__main__for__93__block__94__size));
        // Statement results can be ignored
        stack.pop_back ();
        // End Statement
        ...
        // LHS
        // Variable declaration
        long __main__for__93__block__94__for__95__c;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__93__block__94__for__95__c = *reinterpret_cast<long*>(&__rhs);
        // Result of assignment
        stack.push_back (*reinterpret_cast<long*>(&__main__for__93__block__94__for__95__c));
        // We can ignore the init result
        stack.pop_back ();
        // Using an infinite loop so we can write a separate multi-line condition
        while (1)
        {
            ...
            // LHS
            // Variable declaration
            long __main__for__93__block__94__for__95__block__96__val;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__93__block__94__for__95__block__96__val = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__93__block__94__for__95__block__96__val));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
        ...
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__93__l = __main__for__93__l + *reinterpret_cast<long*>(&__rhs);
        // Result of assignment
        stack.push_back (*reinterpret_cast<long*>(&__main__for__93__l));
        // We can ignore the update result
        stack.pop_back ();
    ...
    __rhs = stack.back ();
    stack.pop_back ();
    __main__res = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__res));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
