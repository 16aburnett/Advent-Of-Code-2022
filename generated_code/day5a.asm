...
main:
         ...
         ; [rbp - 144] - char box (<unset-scope-name>)
            ...
            ;------------------------------------------------------------
                     ; Code Block
                        ...
                        ; Assignment - '='
                           ...
                           ; LHS
                              ; Variable Declaration - nData
                                 mov rax, qword [rbp - 16]  ; __main____Vector__char__pushBack__block__14__if__15__block__16__nData
                           pop rdx ; rhs value
                           mov qword [rbp - 16], rdx
                           push rdx
                        ; Statement results can be ignored
               ...
               ;---------------------------------------------------------
                        ...
                        ; Init
                           ; Assignment - '='
                              ...
                              ; LHS
                                 ; Variable Declaration - i
                                    mov rax, qword [rbp - 24]  ; __main____Vector__char__pushBack__block__14__if__15__block__16__for__17__i
                              pop rdx ; rhs value
                              mov qword [rbp - 24], rdx
                              push rdx
                           ; Loop init result can be discarded
...
;---------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - j
            mov rax, qword [rbp - 136]  ; __main__for__85__block__86__for__88__j
         pop rdx ; rhs value
         ...
         ; Assignment - '='
            ...
            ; LHS
               ; Variable Declaration - box
                  mov rax, qword [rbp - 144]  ; __main__for__85__block__86__for__88__block__89__box
            pop rdx ; rhs value
            mov byte [rbp - 144], dl
            push rdx
         ; Statement results can be ignored
...
;------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 152]  ; __main__for__90__i
         pop rdx ; rhs value
