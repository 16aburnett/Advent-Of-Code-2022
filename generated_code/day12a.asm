...
main:
         ...
         ; [rbp - 72] - int size (<unset-scope-name>)
         ; [rbp - 80] - int c (<unset-scope-name>)
         ; [rbp - 88] - int val (<unset-scope-name>)
         ; [rbp - 96] - int res (<unset-scope-name>)
...
;------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 16]  ; __main____LinkedList__Vec__pushBack__block__80__tail
         pop rdx ; rhs value
         mov qword [rbp - 16], rdx
         push rdx
         ; Statement results can be ignored
         ...
         mov rax, qword [rbp - 24]  ; __main____LinkedList__Vec__pushBack__block__80__node
         pop rdx ; rhs value
         mov qword [rbp - 24], rdx
         push rdx
         ; Statement results can be ignored
...
;------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 16]  ; __main____LinkedList__Vec__pushFront__block__81__head
         pop rdx ; rhs value
         mov qword [rbp - 16], rdx
         push rdx
         ; Statement results can be ignored
         ...
         ; LHS
         ; Variable Declaration - node
         mov rax, qword [rbp - 24]  ; __main____LinkedList__Vec__pushFront__block__81__node
         pop rdx ; rhs value
         mov qword [rbp - 24], rdx
         push rdx
         ; Statement results can be ignored
...
;---------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - tail
         mov rax, qword [rbp - 16]  ; __main____LinkedList__Vec__popBack__block__82__tail
         pop rdx ; rhs value
         mov qword [rbp - 16], rdx
         push rdx
         ; Statement results can be ignored
...
;---------------------------------------------------------------------------------------
         ...
         pop rbp
         ret
         jmp .__endif__85 ; jump to end of condition chain
         ; End of if
.__endif__85:
;---------------------------------------------------------------------------------------
         ; Assignment - '='
         ...
         ; LHS
         ; Variable Declaration - head
         mov rax, qword [rbp - 16]  ; __main____LinkedList__Vec__popFront__block__84__head
         pop rdx ; rhs value
         mov qword [rbp - 16], rdx
         push rdx
         ; Statement results can be ignored
...
;---------------------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 64]  ; __main__for__93__l
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - size
         mov rax, qword [rbp - 72]  ; __main__for__93__block__94__size
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 80]  ; __main__for__93__block__94__for__95__c
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 88]  ; __main__for__93__block__94__for__95__block__96__val
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------
         ...
         pop rdx ; __cond
         cmp rdx, 0 ; ensure condition is true
         je .__elif__97x0 ; jump to first elif
         ; Body
;---------------------------------------------------------------------------------
         ; Code Block
         ; Assignment - '='
...
;---------------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 8]  ; __main__bfs__block__100__frontier
         pop rdx ; rhs value
         mov qword [rbp - 8], rdx
         push rdx
         ; Statement results can be ignored
...
;------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 16]  ; __main__bfs__block__100__while__101__block__102__pos
         pop rdx ; rhs value
         mov qword [rbp - 16], rdx
         push rdx
         ; Statement results can be ignored
...
; =========================================================================================================
         ...
         ; LHS
         ; Variable Declaration - res
         mov rax, qword [rbp - 96]  ; __main__res
         pop rdx ; rhs value
