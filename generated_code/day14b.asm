...
main:
         ...
         ; [rbp - 112] - Path floor (<unset-scope-name>)
         ; [rbp - 120] - Vector<:Vector<:char:>:> board (<unset-scope-name>)
         ; [rbp - 128] - int i (<unset-scope-name>)
         ; [rbp - 136] - int j (<unset-scope-name>)
         ; [rbp - 144] - int i (<unset-scope-name>)
         ; [rbp - 152] - Path path (<unset-scope-name>)
         ; [rbp - 160] - int j (<unset-scope-name>)
         ; [rbp - 168] - Point a (<unset-scope-name>)
         ; [rbp - 176] - Point b (<unset-scope-name>)
         ; [rbp - 184] - int k (<unset-scope-name>)
         ; [rbp - 192] - int k (<unset-scope-name>)
         ; [rbp - 200] - int k (<unset-scope-name>)
         ; [rbp - 208] - int k (<unset-scope-name>)
         ; [rbp - 216] - Point drop_point (<unset-scope-name>)
         ; [rbp - 224] - Point sand_pos (<unset-scope-name>)
         ; [rbp - 232] - int num_sand_at_rest (<unset-scope-name>)
...
;---------------------------------------------------------------------------------------------------------------
         ...
         push rax
         ; LHS
         ; Variable Declaration - floor
         mov rax, qword [rbp - 112]  ; __main__floor
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 120]  ; __main__board
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 128]  ; __main__for__118__i
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - j
         mov rax, qword [rbp - 136]  ; __main__for__118__block__119__for__120__j
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 144]  ; __main__for__127__i
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - path
         mov rax, qword [rbp - 152]  ; __main__for__127__block__128__path
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - j
         mov rax, qword [rbp - 160]  ; __main__for__127__block__128__for__129__j
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 168]  ; __main__for__127__block__128__for__129__block__130__a
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 176]  ; __main__for__127__block__128__for__129__block__130__b
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - k
         mov rax, qword [rbp - 184]  ; __main__for__127__block__128__for__129__block__130__if__131__block__132__for__133__k
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - k
         mov rax, qword [rbp - 192]  ; __main__for__127__block__128__for__129__block__130__if__135__block__136__for__137__k
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - k
         mov rax, qword [rbp - 200]  ; __main__for__127__block__128__for__129__block__130__if__139__block__140__for__141__k
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - k
         mov rax, qword [rbp - 208]  ; __main__for__127__block__128__for__129__block__130__if__143__block__144__for__145__k
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 216]  ; __main__drop_point
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 224]  ; __main__sand_pos
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 232]  ; __main__num_sand_at_rest
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------
         ...
         jmp .__while__150
;---------------------------------------------------------------------------------------
         jmp .__endif__152 ; jump to end of condition chain
         ; End of if
.__endif__152:
;---------------------------------------------------------------------------------------------
;---------------------------------------------------------------------------------------------
...
;---------------------------------------------------------------------------------------
         ...
         jmp .__while__150
;---------------------------------------------------------------------------------------
         jmp .__endif__154 ; jump to end of condition chain
         ; End of if
.__endif__154:
;---------------------------------------------------------------------------------------------
;---------------------------------------------------------------------------------------------
...
;---------------------------------------------------------------------------------------
         ...
         jmp .__while__150
;---------------------------------------------------------------------------------------
         jmp .__endif__156 ; jump to end of condition chain
         ; End of if
.__endif__156:
;---------------------------------------------------------------------------------------------
         ; Assignment - '='
