...
def __main____bubbleSort__int____Vector__tparam0__int (__main__bubbleSort__arr):
    # Body
    #---------------------------------------------------------------------
    # Code Block
    # Statement
    ...
    while (1):
        ...
        while (1):
            ...
            if (__if__22__cond):
                ...
                __arg0 = stack.pop ()
                __obj = stack.pop ()
                __retval = __method____main____Vector__int____set__int__int (__obj, __arg0, __arg1)
                stack.append (__retval)
                # Statement results can be ignored
                stack.pop ()
                # End Statement
...
__arg0 = stack.pop ()
# *** bubbleSort
__res = __main____bubbleSort__int____Vector__tparam0__int (__arg0)
stack.append (__res) # function call result
# Statement results can be ignored
stack.pop ()
# End Statement
...
stack.append(__res)
# LHS
__main__sumTop3Elves = 0
__rhs = stack.pop()
__main__sumTop3Elves = __rhs
stack.append (__main__sumTop3Elves)
# Statement results can be ignored
stack.pop ()
# End Statement
