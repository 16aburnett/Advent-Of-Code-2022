...
while (1):
    ...
    while (1):
        ...
        stack.append (__retval)
        # LHS
        __main__for__85__block__86__for__88__block__89__box = 0
        __rhs = stack.pop()
        __main__for__85__block__86__for__88__block__89__box = __rhs
        stack.append (__main__for__85__block__86__for__88__block__89__box)
        # Statement results can be ignored
        stack.pop ()
        # End Statement
...
stack.append(0)
# LHS
__main__for__90__i = 0
__rhs = stack.pop()
__main__for__90__i = __rhs
stack.append (__main__for__90__i)
# Using an infinite loop so we can write a separate multi-line condition
while (1):
    # Condition
    # Less Than
