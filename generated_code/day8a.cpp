...
int main () {
    ...
    __rhs = stack.back ();
    stack.pop_back ();
    __main__rows = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__rows));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    __rhs = stack.back ();
    stack.pop_back ();
    __main__cols = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__cols));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    // LHS
    // Variable declaration
    long __main__num_visible;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__num_visible = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__num_visible));
    // Statement results can be ignored
    stack.pop_back ();
    // End Statement
    ...
    // LHS
    // Variable declaration
    long __main__for__51__i;
    __rhs = stack.back ();
    stack.pop_back ();
    __main__for__51__i = *reinterpret_cast<long*>(&__rhs);
    // Result of assignment
    stack.push_back (*reinterpret_cast<long*>(&__main__for__51__i));
    // We can ignore the init result
    stack.pop_back ();
    // Using an infinite loop so we can write a separate multi-line condition
    while (1)
    {
        ...
        // LHS
        // Variable declaration
        long __main__for__51__block__52__for__53__j;
        __rhs = stack.back ();
        stack.pop_back ();
        __main__for__51__block__52__for__53__j = *reinterpret_cast<long*>(&__rhs);
        // Result of assignment
        stack.push_back (*reinterpret_cast<long*>(&__main__for__51__block__52__for__53__j));
        // We can ignore the init result
        stack.pop_back ();
        // Using an infinite loop so we can write a separate multi-line condition
        while (1)
        {
            ...
            // LHS
            // Variable declaration
            long __main__for__51__block__52__for__53__block__54__is_visible;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__51__block__52__for__53__block__54__is_visible = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__51__block__52__for__53__block__54__is_visible));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
            ...
            // LHS
            // Variable declaration
            long __main__for__51__block__52__for__53__block__54__is_visible_north;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__51__block__52__for__53__block__54__is_visible_north = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__51__block__52__for__53__block__54__is_visible_north));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
            ...
            // LHS
            // Variable declaration
            long __main__for__51__block__52__for__53__block__54__for__55__ii;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__51__block__52__for__53__block__54__for__55__ii = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__51__block__52__for__53__block__54__for__55__ii));
            // We can ignore the init result
            stack.pop_back ();
            // Using an infinite loop so we can write a separate multi-line condition
            while (1)
            ...
            if (__if__59__cond)
            {
                ...
                // Pre-Increment
                {
                    ...
                    __rhs = stack.back ();
                    stack.pop_back ();
                    __main__num_visible = __main__num_visible + 1;
                    __res = __main__num_visible;
                    stack.push_back (*reinterpret_cast<long*>(&__res));
                }
                // Statement results can be ignored
                stack.pop_back ();
            ...
            // LHS
            // Variable declaration
            long __main__for__51__block__52__for__53__block__54__is_visible_east;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__51__block__52__for__53__block__54__is_visible_east = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__51__block__52__for__53__block__54__is_visible_east));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
            ...
            // LHS
            // Variable declaration
            long __main__for__51__block__52__for__53__block__54__for__61__jj;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__51__block__52__for__53__block__54__for__61__jj = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__51__block__52__for__53__block__54__for__61__jj));
            // We can ignore the init result
            stack.pop_back ();
            // Using an infinite loop so we can write a separate multi-line condition
            while (1)
            {
                ...
                // Pre-Increment
                {
                    ...
                    __rhs = stack.back ();
                    stack.pop_back ();
                    __main__for__51__block__52__for__53__block__54__for__61__jj = __main__for__51__block__52__for__53__block__54__for__61__jj + 1;
                    __res = __main__for__51__block__52__for__53__block__54__for__61__jj;
                    stack.push_back (*reinterpret_cast<long*>(&__res));
                }
                // We can ignore the update result
                stack.pop_back ();
            ...
            // LHS
            // Variable declaration
            long __main__for__51__block__52__for__53__block__54__is_visible_south;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__51__block__52__for__53__block__54__is_visible_south = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__51__block__52__for__53__block__54__is_visible_south));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
            ...
            // LHS
            // Variable declaration
            long __main__for__51__block__52__for__53__block__54__for__67__ii;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__51__block__52__for__53__block__54__for__67__ii = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__51__block__52__for__53__block__54__for__67__ii));
            // We can ignore the init result
            stack.pop_back ();
            // Using an infinite loop so we can write a separate multi-line condition
            while (1)
            {
                ...
                // Pre-Increment
                {
                    ...
                    __rhs = stack.back ();
                    stack.pop_back ();
                    __main__for__51__block__52__for__53__block__54__for__67__ii = __main__for__51__block__52__for__53__block__54__for__67__ii + 1;
                    __res = __main__for__51__block__52__for__53__block__54__for__67__ii;
                    stack.push_back (*reinterpret_cast<long*>(&__res));
                }
                // We can ignore the update result
                stack.pop_back ();
            ...
            // LHS
            // Variable declaration
            long __main__for__51__block__52__for__53__block__54__is_visible_west;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__51__block__52__for__53__block__54__is_visible_west = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__51__block__52__for__53__block__54__is_visible_west));
            // Statement results can be ignored
            stack.pop_back ();
            // End Statement
            ...
            // LHS
            // Variable declaration
            long __main__for__51__block__52__for__53__block__54__for__73__jj;
            __rhs = stack.back ();
            stack.pop_back ();
            __main__for__51__block__52__for__53__block__54__for__73__jj = *reinterpret_cast<long*>(&__rhs);
            // Result of assignment
            stack.push_back (*reinterpret_cast<long*>(&__main__for__51__block__52__for__53__block__54__for__73__jj));
            // We can ignore the init result
            stack.pop_back ();
            // Using an infinite loop so we can write a separate multi-line condition
            while (1)
            {
                ...
                // Pre-Decrement
                {
                    ...
                    __rhs = stack.back ();
                    stack.pop_back ();
                    __main__for__51__block__52__for__53__block__54__for__73__jj = __main__for__51__block__52__for__53__block__54__for__73__jj - 1;
                    __res = __main__for__51__block__52__for__53__block__54__for__73__jj;
                    stack.push_back (*reinterpret_cast<long*>(&__res));
                }
                // We can ignore the update result
                stack.pop_back ();
